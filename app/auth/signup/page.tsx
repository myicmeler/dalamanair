...
export default function SignUpPage() {
  ...
  if (success) return (
    <div style={{...page, textAlign:'center'}}>
      ...
      <Link href="/auth/signin/" style={{fontSize:'13px', color:'rgba(255,255,255,0.4)', textDecoration:'underline'}}>
        ← Back to sign in
      </Link>
    </div>
  )
    ...
    <div style={page}>
      ...
      <div style={card}>
        ...
        <p style={{fontSize:'14px', color:'rgba(255,255,255,0.4)', textAlign:'center', margin:'0 0 28px'}}>
          Already have one?{' '}
          <Link href="/auth/signin/" style={{color:'#f4b942', textDecoration:'none', fontWeight:'500'}}>
            Sign in
          </Link>
        </p>
