  ...
  return (
    <div style={{minHeight:'100vh', backgroundColor:'#0f1419'}}>
      ...
      <div style={{maxWidth:'480px', margin:'0 auto', padding:'60px 20px', textAlign:'center'}}>
        ...
        <p style={{fontSize:'11px', letterSpacing:'0.2em', color:'#f4b942', textTransform:'uppercase', marginBottom:'10px'}}>Booking confirmed</p>
        <h1 style={{fontSize:'26px', fontWeight:'500', color:'#ffffff', marginBottom:'12px'}}>You're all set!</h1>
        ...
        <div style={{display:'flex', gap:'12px', justifyContent:'center', flexWrap:'wrap'}}>
          ...
          <Link href="/" style={{padding:'12px 24px', border:'1px solid rgba(255,255,255,0.15)', color:'rgba(255,255,255,0.6)', borderRadius:'6px', fontSize:'13px', textDecoration:'none'}}>
            Back to home
          </Link>
        </div>
      </div>
