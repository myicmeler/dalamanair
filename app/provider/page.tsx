                      ...
                      assigning === b.id ? (
                        <div className="flex items-center gap-2">
                          ...
                          <button onClick={() => selectedDriver[b.id] && assignDriver(b.id, selectedDriver[b.id])}
                            className="text-xs bg-paper text-ink px-2 py-1 rounded">Assign</button>
                          <button onClick={() => setAssigning(null)} className="text-xs text-muted">✕</button>
                        </div>
                      ) : (
                        <button onClick={() => setAssigning(b.id)}
                          className="text-xs bg-paper text-ink px-3 py-1.5 rounded hover:bg-paper/90 transition-colors">Assign</button>
                      )
                    ) : (
